...
live from ad set 120247164684970259 — never guessed). Two videos:
...
def main() -> None:
    ...
    for line in summary:
        log.info(line)
    final_summary(log, f"Parents-interest 1-1-2 built ({STATUS}, CBO RM100/day): "
